...
Cliente R para o [Ficharium Cloud](https://ficharium.cloud). Permite autenticar, listar projetos, modelos e fichas de campo, e acessar listas de espécies consolidadas.
...
Campos de tipo `especie`, `coordenada` e `ponto` são retornados como list-columns.
...
A documentação completa de cada função — parâmetros, tipos de retorno e exemplos — está disponível em [biosensu.github.io/fichaR/reference](https://biosensu.github.io/fichaR/reference).
